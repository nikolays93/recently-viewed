...
class Plugin {
	...
	/**
	 * Get cookie name for save recently viewed post ids.
	 *
	 * @return string
	 */
	public function get_cookie_name() {
		return apply_filters( self::PREFIX . 'get_cookie_name', self::DOMAIN );
	}

	/**
	 * Read serialized cookie value
	 *
	 * @return string
	 */
	public function get_cookie() {
		return isset( $_COOKIE[ $this->get_cookie_name() ] ) ? $_COOKIE[ $this->get_cookie_name() ] : '';
	}

	/**
	 * Unserialize array from cooke it
	 *
